...
public class TurtleGraphics
{
    ...
    public static int turnRight(int d)
    {
        ...
        // switch case to determine the new facing direction based of d (the current direction)
        switch(d){
            case 0:
                d = 1;
                break;
        ...
        // returns the correct updated direction the turtle is facing
        return d;
    }
    ...
    public static void printArray(int[][] a)
    {
        ...
        {
            // To be completed by student.
            // for() to go through each array element to determine the correct output
            for(int j = 0; j < a.length; j++){
                if(a[i][j] == 1) // if pen was down and 'drawing' print "* "
                    System.out.print("* ");
                else
                    System.out.print("  ");
            }
            
            // enter a new line for the next row of elements
            System.out.println();
        }
    }
