...
public class MyHashSet<E extends Comparable<E>> implements Collection<E> {
  ...
  // Hash table is an array with each cell that is an AVL tree
  ...
  public boolean add(E e) {
    ...
    // Create a AVL tree for the bucket if it is not created
    if (table[bucketIndex] == null) {
  ...
  public boolean remove(Object e) {
    ...
    // Create an AVL tree for the bucket if it is not created
    if (table[bucketIndex] != null) {
      AVLTree<E> bucket = table[bucketIndex];
      bucket.remove(e);
    }
